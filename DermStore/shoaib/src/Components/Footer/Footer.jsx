  ...
  return (
    <div style={{border:'1px  black', margin:'30px'}}>
      <div >
        ...
        <hr
          style={{  color: "lightgray",  width: "75%",     margin: "auto",   marginTop: "30px",  }}
        />
        <div
          style={{    display: "flex",    width: "65%",  margin: "auto", justifyContent: "space-between",     marginTop: "25px",  }}
        >
          <p>Copyright©2020. All Rights Reserved</p>
          <img
            style={{ width: "9%" }} src="https://cdn.shopify.com/s/files/1/0449/5225/6667/files/ting.png?v=1599565040"    alt=""
          />
        </div>
      </div>
<div>
